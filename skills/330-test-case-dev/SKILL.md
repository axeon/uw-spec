...
循环开始 (round=1)
  ...
  │    对 test/scripts/ 下四类测试脚本执行评审
  │
  ├─▶ 获取评审报告: test/reviews/REVIEW-CODE-YYMMDDHHMM.md
  │
  ├─▶ 判断结果:
  │    ├─ 评分 ≥ 95 → 输出结论，循环结束 ✓
  │    └─ 评分 < 95 → 进入修复步骤

...
| 前端项目 | `frontend/{项目名}-guest-uniapp/` | 230-init初始化 + 230-gencode生成的代码 |
...
调用技能 `221-guest-uniapp-design-review`，评分 ≥ 95 通过，< 95 按下表修复后重新评审（最多5轮，round ≥ 6 强制退出）:

...
### 1. 准备阶段
- **读取源技能**：读取 [320-admin-web-dev/SKILL.md](../320-admin-web-dev/SKILL.md) 全文，提取所有开发规范和约定，作为评审的权威依据
- 获取前端代码和测试代码
- 获取测试覆盖率报告
- 准备检查清单
...
## 输出要求
**报告位置**: `PROJECT_ROOT/frontend/{项目名}-admin-web/reviews/REVIEW-CODE-YYMMDDHHMM.md`

---
name: 600-feature-clarify
description: 功能需求澄清技能。当需要开发新功能时首先触发：(1)分析功能需求和业务场景, (2)澄清需求模糊点和边界条件, (3)定义验收标准和测试要点, (4)评估功能影响范围, (5)生成功能需求文档, (6)合并到PRD主文档。请务必在用户提及开发新功能、添加功能、功能迭代、需求澄清时使用此技能。
alwaysApply: false
...
**确认后流转**: 进入 610-feature-tech-design

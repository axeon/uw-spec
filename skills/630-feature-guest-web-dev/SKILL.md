...
**REVIEW评审技能**: `631-feature-guest-web-dev-review`
...
Web前端开发完成后，调用 `631-feature-guest-web-dev-review`。

- [ ] 已重新读取本节全部内容
- [ ] 已调用 `631-feature-guest-web-dev-review`
- [ ] 已收到评审通过确认（评分 ≥ 95）
...
**文件位置**: `PROJECT_ROOT/frontend/{项目名}-guest-web/issues/FEATURE-DESIGN-{YYMMDD}-{简述}-guest-web.md`

...
| 输入项 | 来源 | 说明 |
|--------|------|------|
| 功能代码 | `frontend/{项目名}-guest-web/src/` | 功能开发产出的代码 |
| 测试代码 | `frontend/{项目名}-guest-web/src/**/*.spec.ts` | 单元测试 |
| 技术方案 | `frontend/{项目名}-guest-web/issues/FEATURE-DESIGN-*-tech-design.md` | 610阶段方案 |

---
name: 220-md-uniapp-init
description: 移动端UniApp项目初始化技能。当需要创建UniApp跨平台项目时触发：(1)从uw-uniapp-template.zip模板解压项目结构，(2)全文替换模板关键字为实际项目名，(3)验证项目结构完整性。请务必在用户提及UniApp项目初始化、小程序项目创建、移动端项目搭建、跨平台项目初始化时使用此技能。
alwaysApply: false

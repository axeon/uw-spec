...
**REVIEW评审技能**: `731-bugfix-guest-web-review`
...
Web前端修复完成后，**自动调用 `731-bugfix-guest-web-review`**，无需等待用户确认。

### 5. 生成修复文档

**文件位置**: `PROJECT_ROOT/frontend/{项目名}-guest-web/issues/BUGFIX-DESIGN-{YYMMDD}-{简述}-guest-web.md`

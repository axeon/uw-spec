...
**报告位置**：`PROJECT_ROOT/database/log/DDL-EXECUTION-REPORT-{YYMMDDHHMM}.md`
...
调用技能 `301-database-ddl-execution-review`，评分 ≥ 95 通过，< 95 按下表修复后重新评审（最多5轮，round ≥ 6 强制退出）:
...
**执行报告**: `PROJECT_ROOT/database/DDL-EXECUTION-REPORT-{YYMMDDHHMM}.md`

**评审报告**: `PROJECT_ROOT/database/reviews/REVIEW-DDL-EXECUTION-YYMMDDHHMM.md`

...
> 跨技能共用的TDD红绿重构说明和通用示例。被 310-java-uniweb-dev、320-admin-web-dev、320-guest-web-dev、320-admin-uniapp-dev、320-guest-uniapp-dev、620-feature-java-uniweb-dev、630-feature-admin-web-dev、630-feature-guest-web-dev、630-feature-admin-uniapp-dev、630-feature-guest-uniapp-dev、720-bugfix-java-uniweb、730-bugfix-admin-web、730-bugfix-guest-web、730-bugfix-admin-uniapp、730-bugfix-guest-uniapp 等技能引用。

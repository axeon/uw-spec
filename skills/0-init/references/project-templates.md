...
| 6-feature | 开发组 | 620, 630, 640 | 全部完成后进入验收 |
| 7-bugfix | 修复组 | 720, 730, 740 | 全部完成后进入验收 |
...
**阶段6/7**:
- 功能开发: 600 → 601 → 610 → (620/630/640并行) → 650 → 660
- Bug修复: 700 → 701 → 710 → (720/730/740并行) → 750 → 760
- 阶段6/7可独立循环，不影响主线流程

...
调用技能 `321-admin-uniapp-dev-review`，评分 ≥ 95 通过，< 95 按 [REVIEW-FIX 循环规范](../0-init/references/review-fix-loop.md) 执行修复循环。
...
- [321-admin-uniapp-dev-review](../321-admin-uniapp-dev-review/SKILL.md) - PLAN-REVIEW循环评审

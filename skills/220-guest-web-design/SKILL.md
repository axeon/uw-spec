...
调用技能 `221-guest-web-design-review`，评分 ≥ 95 通过，< 95 按 [REVIEW-FIX 循环规范](../0-init/references/review-fix-loop.md) 执行修复循环。
...
设计（含 PLAN-REVIEW 循环）通过评审后，提示用户进入 **320-guest-web-dev** 进行Web前端业务开发。

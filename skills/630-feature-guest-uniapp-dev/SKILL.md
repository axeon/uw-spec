...
调用技能 `631-feature-guest-uniapp-dev-review`，评分 ≥ 95 通过，< 95 按 [REVIEW-FIX 循环规范](../0-init/references/review-fix-loop.md) 执行修复循环。
...
**文件位置**: `PROJECT_ROOT/frontend/{项目名}-guest-uniapp/issues/FEATURE-DESIGN-{YYMMDD}-{简述}-guest-uniapp.md`

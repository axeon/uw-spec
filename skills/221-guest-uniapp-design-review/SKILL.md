...
### 1. 准备阶段
- **读取源技能**：读取 [220-guest-uniapp-design/SKILL.md](../220-guest-uniapp-design/SKILL.md) 全文，提取所有架构约定和设计完成标准，作为评审的权威依据
- 读取原型设计文件
- 确定评审范围（用户端/商户端）
- 准备检查清单
...
## 输出要求
**报告位置**: `PROJECT_ROOT/frontend/{项目名}-guest-uniapp/reviews/REVIEW-DESIGN-YYMMDDHHMM.md`

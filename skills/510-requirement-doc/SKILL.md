...
description: 需求文档整理技能。当需要整理项目需求交付物时触发：(1)汇总PRD产品需求文档, (2)整理用户故事地图和用户画像, (3)归档业务流程图和时序图, (4)汇总验收标准和测试要点, (5)整理需求变更记录, (6)编写需求追溯矩阵。请务必在用户提及需求文档整理、PRD汇总、需求归档、需求交付物、文档整理时使用此技能 ⚠️【强制】完成后必须调用 511-requirement-doc-review，未通过前禁止声称完成。
alwaysApply: false
